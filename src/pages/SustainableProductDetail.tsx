  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-br from-secondary/10 to-logo-blue/10 rounded-full blur-3xl" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-secondary to-logo-blue text-primary-foreground mb-6">
              ...
              <div className="flex flex-wrap gap-4">
                <Button className="bg-gradient-to-r from-secondary to-logo-blue hover:opacity-90 text-white rounded-full px-8 py-6 text-lg">
                  Request Demo
      ...
      <section className="py-20 bg-gradient-to-r from-secondary/10 to-logo-blue/10">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-secondary to-logo-blue flex items-center justify-center mx-auto mb-6">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-secondary/20 to-logo-blue/20 rounded-3xl blur-3xl" />
                ...
                <div className="grid grid-cols-3 gap-6">
                    ...
                    <div className="flex items-end justify-between h-40 gap-2">
                      {[65, 78, 52, 89, 73, 45, 61].map((height, i) => (
                        <div key={i} className="flex-1 flex flex-col items-center gap-2">
                          <div 
                            className="w-full bg-gradient-to-t from-secondary to-logo-blue rounded-t-lg transition-all"
                            style={{ height: `${height}%` }}
                          />
                  ...
                  <div className="bg-muted/30 rounded-2xl p-6 border border-border/50">
                    ...
                    <div className="relative h-40 flex items-center justify-center">
                      <div className="w-32 h-32 rounded-full border-8 border-secondary border-t-logo-blue border-r-primary" />
                    ...
                    {["Zone A", "Zone B", "Zone C", "Zone D", "Zone E"].map((zone, i) => (
                      <div key={zone} className="text-center">
                        <div className={`w-12 h-12 rounded-xl mx-auto mb-2 flex items-center justify-center ${
                          i === 2 ? "bg-yellow-500/20 text-yellow-500" : "bg-primary/20 text-primary"
                        }`}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {product.features.map((feature, index) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-secondary to-logo-blue flex items-center justify-center mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {product.benefits.map((benefit, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-secondary to-logo-blue flex items-center justify-center mb-6">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-4">
            {product.useCases.map((useCase, index) => (
              <motion.div
                ...
                className="bg-background rounded-2xl p-6 border border-border/50 text-center hover:border-primary/30 transition-colors"
              >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative bg-gradient-to-br from-secondary/20 to-logo-blue/20 rounded-3xl p-12 text-center border border-primary/20"
          >
